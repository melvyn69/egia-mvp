  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 xl:grid-cols-[1.25fr_0.75fr]">
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Un programme simple par établissement, basé uniquement sur les
                  visites.
                </p>
              </div>
              <Button
        ...
        <Card>
          <CardHeader>
            <CardTitle>Adhésion client</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-xs text-slate-500">
              Ce lien sera appelé depuis le funnel avis, pour les clients
              satisfaits et insatisfaits. Aucune récompense n’est liée à une
              note Google.
            </div>
          </CardContent>
        </Card>
