...
const Billing = ({ isAdmin }: BillingProps) => {
  ...
  return (
    <div className="space-y-5 rounded-2xl bg-slate-50/80 p-3 pb-28 sm:space-y-6 sm:rounded-3xl sm:p-6 lg:pb-6">
      <div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid gap-2 text-sm text-slate-600 sm:grid-cols-2">
              <div className="flex min-w-0 items-start gap-2">
                ...
                <span>Prochain renouvellement : N/A</span>
              </div>
              <div className="flex min-w-0 items-start gap-2">
        ...
        <CardContent className="px-4 pb-4 sm:px-6 sm:pb-6">
          <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_340px] lg:gap-6">
            ...
            <div className="rounded-2xl bg-slate-100 p-4 sm:p-5">
              ...
              <Button className="mt-5 w-full bg-violet-700 hover:bg-violet-800 sm:w-auto" onClick={scrollToPricing}>
                Voir les offres
                <ArrowRight size={16} />
              </Button>
            </div>
      ...
      <div className="fixed inset-x-0 bottom-16 z-20 border-t border-slate-200 bg-white/95 p-3 shadow-[0_-16px_36px_-24px_rgba(15,23,42,0.6)] backdrop-blur lg:hidden">
